    ...
    <div>
        <transition name="cartTransition">
            <div tabindex="0" class="cart" v-show="$parent.showCart" >
                <div v-if="cartDone" class="cart-left">
                    ...
                    <div class="col-md-12 animated fadeInLeft delay-600">
                        <md-button class="md-raised md-accent m-0 w-100 white-background font-weight-bold">
                            Wyślij zapytanie
                        </md-button>
                    </div>
                </div>
                <div class="cart-right animated fadeInRight" style="animation-duration:300ms;">
                        ...
                        <div v-for="(item, key) in cart.items" class="cart-item w-100 mb-3">
                            <div class="d-flex flex-wrap">
                                <div class="col-md-3 pr-0">
                                    <img class="w-100" :src="getImage(JSON.parse(item.images)[0])">
                                </div>
                                <div class="col-md-7">
                                ...
                                <div class="col-md-2 flex-column">
                                    <md-button :disabled="cartDone" @click="(editItem.id == item.id)? editItem={} : editItem = Object.assign({}, item)" class="md-mini md-icon-button md-raised md-primary m-0">

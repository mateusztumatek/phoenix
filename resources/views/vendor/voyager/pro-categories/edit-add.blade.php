                        ...
                        <!-- Adding / Editing -->
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <ul style="list-style-type: none; padding-left: 0px">
                                    <li><label><input value="0" type="radio" name="parent" style="margin-right: 5px" checked>Kategoria nadrzędna</label></li>
                                    @foreach($categories as $category)
                                        @if(isset($parent_categories))
                                            <li><label><input value="{{$category->id}}" type="radio" name="parent" style="margin-right: 5px"  @if($category == $parent_categories) checked @endif>{{$category->name}}</label></li>

                                        @else
                                            <li><label><input value="{{$category->id}}" type="radio" name="parent" style="margin-right: 5px">{{$category->name}}</label></li>

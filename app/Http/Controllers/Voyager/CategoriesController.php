...
class CategoriesController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $parent_categories = Category::where('id', $cat->parent_id)->first();
        return view('vendor.voyager.pro-categories.edit-add', compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'categories', 'parent_categories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('vendor.voyager.pro-categories.edit-add', compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'categories'));
    }

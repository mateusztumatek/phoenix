...
class ProductController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        foreach (DB::table('product_categories')->where('product_id', $product->id)->get() as $cat){
            array_push($product_categories, Category::findOrFail($cat->category_id));
        }
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('parent_id', null)->get();
        $materials = Material::all();
        return view('vendor.voyager.products.edit-add', compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'categories', 'materials'));
    }
